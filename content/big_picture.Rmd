...
library(ggplot2)
library(tidyr)
clean_wage %>% ggplot(aes(x = CCR, y = MHI)) + geom_smooth()+ labs(title="College Completion Rate after 25 vs. Median Household Income", x="College Completion Rate after 25", y=" Median Household Income")
```
